...
public class LoginForm extends javax.swing.JFrame {
    ...
    public LoginForm() {
        ...
        getContentPane().setBackground(Color.WHITE); // Aplicando a cor 
        verificandoConexao();
    }
    ...
    private void initComponents() {
        ...
        logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/rh.jpg"))); // NOI18N
    ...
    private void validarUsuario(){
        ...
        if(!senhaInformada.isEmpty() && !loginInformado.isEmpty()){
            ...
            login = loginDao.consultarLogin(loginInformado);
            
            if(login.getUsuario() != null && verificarSenha()){
                Home telaInicial = new Home();
                telaInicial.setVisible(true); //Abrindo a tela do sistema
                dispose();
                loginDao.adicionarLogin(login.getCodUsuario()); //Adicionando o login na tabela de Login
    ...
    private void verificandoConexao(){
        String caminhoArquivo = "C:\\Users\\Lucas Oliveira\\Documents\\Projetos\\HumanResources\\config.txt"; //Caminho onde salva o arquivo
    ...
    private boolean verificarSenha(){
        ...
        String senhaInformada = campoSenha.getText();
        String hashObtido = login.getHashSenha();
        String saltObtido = login.getSaltSenha();
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Erro ao tentar validar o usuário", "Erro",JOptionPane.WARNING_MESSAGE);
        }
