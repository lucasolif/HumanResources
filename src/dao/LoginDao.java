...
public class LoginDao {
    ...
    public void adicionarLogin(int codUsuario){
        ...
        try{  
            ...
            String sql= "INSERT INTO Login (Usuario,DataLogin)VALUES (?,GETDATE())";
    ...
    public Login consultarLogin(String usuario){
        ...
        //Consultar para validar os dados do login
    public boolean consultarExistenciaUsuario(){
        ...
        try{           
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "Erro ao tentar verificar a existências de usuários", "Erro 004", JOptionPane.ERROR_MESSAGE);
        }finally{
            // Fechar recursos
            try{
                if (rs != null) rs.close();
